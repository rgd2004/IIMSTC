...
import { Users, Store, Package, TrendingUp, MessageSquare, Settings } from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  const [recentActivity, setRecentActivity] = useState([
    { id: 1, type: 'user', message: 'New user registered', time: '2 mins ago', icon: Users },
    { id: 2, type: 'seller', message: 'Seller verification request', time: '15 mins ago', icon: Store },
    { id: 3, type: 'order', message: 'New order placed', time: '1 hour ago', icon: Package },
    { id: 4, type: 'support', message: 'Customer support message received', time: '2 hours ago', icon: MessageSquare }
  ]);
  ...
  return (
    <div className="admin-dashboard">
      ...
      <div className="admin-nav-tabs">
        ...
        <button 
          className={`nav-tab ${activeTab === 'sellers' ? 'active' : ''}`}
